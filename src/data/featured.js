export default {
  educational: {
    ...
    img: "1rgDiTeBFlve33DKOHFuY7jjlXr_qkJOA",
    areasDeveloped: [
  ...
  playMovement: {
    ...
    img: "1FkGsC6MGmgoaNuaHHIrKUzwGq76ou-_Q",
    areasDeveloped: [
      "Attention",
  ...
  languageDrama: {
    ...
    img: "19RDolKIXZfZmF9XjkoewUnhWASlxdy0c",
    areasDeveloped: [
      "Communication",
      "Problem solving",
  ...
  assistiveTechnology: {
    ...
    img: "1qqu4h1CQAKike2DY89qBoEKkI8XWXLQC",
    areasDeveloped: [
      "Non flame cooking",
  ...
  educationalExcursion: {
    ...
    img: "1flPaBvx-Pihp16GRnzXqFhFQiKFf_qKI",
  },
  workshops: {
    ...
    img: "11lZzNqe-Q6Qjg8cHk9IDsTwxJXnsAmU0",
    areasDeveloped: [
  ...
  camp: {
    ...
    img: "1MMrdgHrvFpULOXdm57Bj0KU8SL51xI0X",
    activities: [
