...
const CallToAction = () => {
  return (
    <Box as="section" id="aboutus" sx={styles.callToAction}>
      <Container>
        <Flex sx={styles.flex}>
          <Box sx={styles.content}>
            <Text as="span">Behind the design</Text>
            <Heading as="h3">Vision & Mission</Heading>
            <Text as="p">
              Our Vision is a world where disabilities are not an obstacle, but
              an opportunity.
              <br />
              Our Mission is to improve the lives of individuals with social,
